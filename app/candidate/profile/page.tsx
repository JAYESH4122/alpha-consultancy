...
export default function CandidateProfilePage() {
  ...
  return <>
    <PageHeader title="Employee profile" description="Update your matching information, resume, consent, and privacy requests." />
