...
export const tourRoles: Array<{ key: TourRole; label: string; description: string }> = [
  ...
  { key: "candidate", label: "Employee", description: "Explores and applies" },
];
...
export const tourStages: TourStage[] = [
  {
    ...
    summary: "The employer provides a complete hiring brief. It goes to Alpha Consultancy first—not directly to employees.",
    actor: "employer",
    reference: "JOB-2410",
  ...
  },
  {
    ...
    summary: "Alpha Consultancy checks the employer and requirement before any employee receives the opportunity.",
    actor: "admin",
    reference: "JOB-2410",
    roleTitle: "Warehouse Associate",
    location: "Kochi",
    ...
    nextDescription: "Approval makes an anonymized version available only to suitable employees.",
  ...
  {
    number: 3,
    shortLabel: "Employee shows interest",
    title: "Employee receives a private match",
    summary: "A suitable employee sees the approved opportunity without the company identity, exact work area, or contact details and chooses whether to apply.",
    actor: "candidate",
    ...
    workspaceHref: "/employee/matches",
    workspaceLabel: "Open employee job matches",
    actions: {
      employer: "See that an employee entered the anonymous pipeline—no identity or resume.",
    ...
    visibility: {
      ...
      admin: "Employee profile, resume, consent, and answers",
      candidate: "Anonymized job details and match reasons",
    },
  },
  {
    number: 4,
    shortLabel: "Admin screens employee",
    title: "Admin screens the employee",
    summary: "Alpha Consultancy reviews the employee privately and decides whether the application is ready for handoff.",
    actor: "admin",
    reference: "APP-1042",
    roleTitle: "Warehouse Associate",
    location: "Kochi",
    checks: ["Identity passed", "Resume passed", "Eligibility passed"],
    nextAction: "Collect employee handoff consent",
    nextDescription: "The employee must approve sharing verified details with this specific employer.",
    workspaceHref: "/admin/applications",
    workspaceLabel: "Open admin screening",
    actions: {
      employer: "Continue seeing an anonymous employee while Alpha Consultancy screens the application.",
    ...
    visibility: {
      employer: "Anonymous employee and pipeline status only",
      admin: "Verified employee records and private notes",
  ...
  },
  {
    ...
    roleTitle: "Warehouse Associate",
    location: "Kochi",
    checks: ["Employee handoff consent", "Employer data-use acceptance", "Admin interview clearance"],
    ...
    actions: {
      employer: "Receive the released employee identity, resume, and interview record.",
    ...
    visibility: {
      employer: "Released employee identity, resume, and interview details",
